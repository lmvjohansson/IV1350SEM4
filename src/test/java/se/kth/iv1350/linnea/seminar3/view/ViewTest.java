...
public class ViewTest {
    ...
    @Test
    public void testRunFakeExecutionFirstItem() {
    ...
    @Test
    public void testRunFakeExecutionSecondItem() {
        instance.runFakeExecution();
        String output = outContent.toString();
    ...
    @Test
    public void testRunFakeExecutionRunningTotal() {
        instance.runFakeExecution();
        String output = outContent.toString();
    ...
    @Test
    public void testRunFakeExecutionRunningVat() {
        instance.runFakeExecution();
        String output = outContent.toString();
    ...
    @Test
    public void testRunFakeExecutionTotalCost() {
        instance.runFakeExecution();
        String output = outContent.toString();
    ...
    @Test
    public void testRunFakeExecutionReceipt() {
        instance.runFakeExecution();
        String output = outContent.toString();
    ...
    @Test
    public void testRunFakeExecutionChange() {
        instance.runFakeExecution();
        String output = outContent.toString();
