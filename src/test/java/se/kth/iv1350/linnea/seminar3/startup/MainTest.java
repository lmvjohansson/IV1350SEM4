...
public class MainTest {
    ...
    @Test
    public void testMainPrintsFirstItem() throws IOException {
        String[] args = null;
        Main.main(args);
    ...
    @Test
    public void testMainPrintsSecondItem() throws IOException {
        String[] args = null;
        Main.main(args);
        String output = outContent.toString();
    ...
    @Test
    public void testMainPrintsRunningTotal() throws IOException {
        String[] args = null;
        Main.main(args);
        String output = outContent.toString();
    ...
    @Test
    public void testMainPrintsRunningVat() throws IOException {
        String[] args = null;
        Main.main(args);
        String output = outContent.toString();
    ...
    @Test
    public void testMainPrintsTotalCost() throws IOException {
        String[] args = null;
        Main.main(args);
        String output = outContent.toString();
    ...
    @Test
    public void testMainPrintsReceipt() throws IOException {
        String[] args = null;
        Main.main(args);
        String output = outContent.toString();
    ...
    @Test
    public void testMainPrintsChange() throws IOException {
        String[] args = null;
        Main.main(args);
        String output = outContent.toString();
